...
public class ProductMasterDaoImpl implements ProductMasterDao {
	...
	public static final String INS_ITEM_QRY = "INSERT INTO CoronaKitItem(Prodid,description,prodName,prodMRP) values(?,?,?,?)";
	public static final String UPD_ITEM_QRY = "UPDATE CoronaKitItem SET description=?,prodName=?,prodMRP=? WHERE Prodid=?";
	public static final String DEL_ITEM_QRY = "DELETE FROM CoronaKitItem WHERE Prodid=?";
	public static final String SEL_ITEM_QRY_BY_ID = "SELECT Prodid,description,prodName,prodMRP FROM CoronaKitItem WHERE Prodid=?";
	public static final String SEL_ALL_ITEMS_QRY = "SELECT Prodid,description,prodName,prodMRP FROM CoronaKitItem";
